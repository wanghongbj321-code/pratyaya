...
| 节号 | section 名称 | 内容 |
|---|---|---|
| 6 | 阶段地图 | 动态阶段 × 行动 / 触点与系统 / 情绪 / 等待与返工 / 风险节点 |
| 6a | 质量鉴别 | user_perspective / business_outcome / friction_visible / no_solution_bias 四维度判定 |
| 6b | 关键断点与机会 | 等待 / 返工 / 风险 / 情绪低点形成的断点摘要 |
...
| 6：阶段 n wait_rework | `journey-stage-{n}-wait-rework` |
| 6：阶段 n risk | `journey-stage-{n}-risk` |
| 6a：user_perspective | `journey-quality-user-perspective` |
| 6a：business_outcome | `journey-quality-business-outcome` |
| 6a：friction_visible | `journey-quality-friction-visible` |
| 6a：no_solution_bias | `journey-quality-no-solution-bias` |
| 6b：关键断点与机会 | `journey-friction-summary` |
...
- **维度**：user_perspective / business_outcome / friction_visible / no_solution_bias
- **判定**：通过 / 不通过
...
| `major` | 会显著改变断点判断或旅程边界 | 必须关闭或接受风险 |

...
| `JOURNEY-GATE-03` | 至少标出 2 个等待 / 返工信息、1 个风险节点，或明确说明未发现 | `information_integrity` | low | JOURNEY-map / JOURNEY-friction |
...
| 分类 | 含义 | 用户 override |
|---|---|---|
| `information_integrity` | 正式产物能否真实成立（阶段数量、主表字段、断点覆盖等） | **否** |
